...
import { gotoCommandManifestLocationCmd, gotoToolManifestLocationCmd } from "./commands/gotocmdlocation";
...
import { openCommandCmd, openToolCmd } from "./commands/opencommand";
...
export function registerAllCommands(manager: ExtensionManager) {
  ...
  manager.registerCommand("opentool", async (...args: any[]) => openToolCmd(manager, args));
  manager.registerCommand("goto.tool", async (...args: any[]) => gotoToolManifestLocationCmd(manager, args));
